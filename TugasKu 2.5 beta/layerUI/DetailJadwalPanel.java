...
public class DetailJadwalPanel extends javax.swing.JPanel { 
    ...
    public DetailJadwalPanel(MainApp mainApp, Session userSession) {
        ...
        // ===== Apply renderer to all columns of the unfinished tasks table =====
        for (int i = 0; i < jTableTugasPenting1.getColumnCount(); i++) {
            jTableTugasPenting1.getColumnModel().getColumn(i).setCellRenderer(deadlineRenderer);
        }
        setupTableListeners();
    }
