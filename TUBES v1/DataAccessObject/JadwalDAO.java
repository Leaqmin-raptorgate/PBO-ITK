...
public class JadwalDAO {
    ...
    public int create(jadwal jadwalObj) { // Renamed and changed return type
    ...
    public jadwal findById(int id) { // Renamed for consistency
    ...
    // New method: Find jadwal by hari and sesi
    ...
    public boolean update(jadwal jadwalObj) { // Renamed for consistency
